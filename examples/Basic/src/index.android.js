...
const publisherHeight = 2 * deviceHeight / 3 - 20;
    ...
    return (
      <View style={styles.container}>
        <View style={styles.videoContainer}>
          <PublisherView
            apiKey={config.opentokConfigs.apiKey}
            sessionId={config.opentokConfigs.sessionId}
            token={config.opentokConfigs.publisherToken}
        ...
        <View style={styles.infoContainer}>
          <View style={styles.blockLeft}>
            <SubscriberView
              apiKey={config.opentokConfigs.apiKey}
              sessionId={config.opentokConfigs.sessionId}
              token={config.opentokConfigs.subscriberToken}
