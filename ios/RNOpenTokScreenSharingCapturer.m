...
@implementation RNOpenTokScreenSharingCapturer
{
...
- (void)initCapture
{
    ...
    dispatch_source_set_event_handler(_timer, ^{
        @autoreleasepool {
            __block UIImage* screen = [self makeScreenshot];
...
- (CGImageRef)resizeAndPadImage:(UIImage*)sourceUIImage
{
    ...
    [RNOpenTokScreenSharingCapturer dimensionsForInputSize:sourceSize
